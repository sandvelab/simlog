...
test-all: ## run pytest, doctests, examples
	pytest --cov=simlog --cov-report html
	pytest --cov=simlog --cov-report html --cov-append scripts/*_example.py
	pytest --cov-report html --cov=simlog --cov-append --doctest-modules simlog/
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs_source/simlog.rst
	rm -f docs_source/modules.rst
	sphinx-apidoc -o docs_source/ simlog
